<template>
  <div class="about-us">
    <div class="container">
      <div class="tab">
        <h3 class="tab-title">Наша компания</h3>

        <div class="cols">
          <div class="builder-image">
            <img :src="BuilderImage" alt="" class="img" />
          </div>
          ...
          <div class="about-col">
            <div class="card">
              <div class="content">
                <h1 class="title">
                  СК «FAVORIT» <span>- меняем представление о строительстве бань</span>
                </h1>

                <p class="description">
                  Мы используем передовые, в том числе модульные технологии, чтобы предложить вам
                  готовое решение «под ключ» в рекордные сроки.
                </p>
...
.about-us {
  ...
  .container {
    ...
    .tab {
      border-radius: 30px;
      background: url('@/assets/images/forest.jpg') no-repeat center top;
        ...
        .about-col {
          ...
          .card {
            ...
            .content {
              ...
              .title {
                @include mixins.text-title(30px);
                font-weight: bold;
                color: variables.$color-accent-light;
